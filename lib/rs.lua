...
rs.conf = function(options)
    ...
    if options.game_width then
        ...
        if options.game_width < 0 then
            error(".conf: field \'game_width\' should be 0 or more. You passed: " .. tostring(options.game_width) .. ".",
                2)
        end
    ...
    if options.scale_mode then
        ...
        if options.scale_mode > 4 or options.scale_mode < 1 then
            error("conf: field \'scale_mode\' can be only 1, 2, 3 and 4. You passed: " ..
                tostring(options.scale_mode) .. ".")
        end
